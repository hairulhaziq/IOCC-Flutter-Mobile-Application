...
class FormSemasa extends StatefulWidget {
  final ReportModel report;

  FormSemasa(this.report);

  @override
  _FormSemasaState createState() => _FormSemasaState();
}

class _FormSemasaState extends State<FormSemasa> {
