...
class FormLain extends StatefulWidget {
  final ReportModel report;

  FormLain(this.report);

  @override
  _FormLainState createState() => _FormLainState();
}

class _FormLainState extends State<FormLain> {
  ...
  Future<void> _validateSave() async {
    if (this._key.currentState.validate()) {
      ...
      var jsonBody = jsonEncode(<String, dynamic>{
        ...
        "DepartmentId":
            LookUpService.getDepartmentIdByName(_selectedDepartment),
  ...
  void initState() {
    ...
    _selectedDepartment = widget.report.departmentName;
    super.initState();
  }
