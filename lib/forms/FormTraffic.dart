...
class FormTraffic extends StatefulWidget {
  final ReportModel report;

  FormTraffic(this.report);

  @override
  _FormTrafficState createState() => _FormTrafficState();
}

class _FormTrafficState extends State<FormTraffic> {
