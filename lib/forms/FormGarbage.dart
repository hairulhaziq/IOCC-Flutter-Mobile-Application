...
class FormGarbage extends StatefulWidget {
  final ReportModel report;

  FormGarbage(this.report);

  @override
  _FormGarbageState createState() => _FormGarbageState();
}

class _FormGarbageState extends State<FormGarbage> {
