...
class FormHalangan extends StatefulWidget {
  final ReportModel report;

  FormHalangan(this.report);

  @override
  _FormHalanganState createState() => _FormHalanganState();
}

class _FormHalanganState extends State<FormHalangan> {
  ...
  Future<void> _validateSave() async {
    if (this._key.currentState.validate()) {
      ...
      void sendSocketIOMessage(jsonEncode) async {
        var main = {};
        ...
        main["ReportFeeds"] = "";
        main["ReportingModeId"] = widget.report.reportingModeId;
      ...
      if (response.statusCode == 200) {
        ...
        sendSocketIOMessage(jsonEncode);
  ...
  void initState() {
    _selectedAction =
        LookUpService.getReportStatusList(widget.report.reportStatusName)[0];
    super.initState();
  }
          ...
          child: Column(
            children: <Widget>[
              ...
              DropdownButtonFormField<String>(
                ...
                items: LookUpService.getReportStatusList(
                        widget.report.reportStatusName)
