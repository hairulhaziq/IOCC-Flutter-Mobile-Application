...
class FormHawker extends StatefulWidget {
  final ReportModel report;

  FormHawker(this.report);

  @override
  _FormHawkerState createState() => _FormHawkerState();
}

class _FormHawkerState extends State<FormHawker> {
