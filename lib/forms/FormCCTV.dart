...
class FormCCTV extends StatefulWidget {
  ReportModel report = ReportModel();

  FormCCTV(this.report);

  @override
  _FormCCTVState createState() => _FormCCTVState();
}

class _FormCCTVState extends State<FormCCTV> {
  ...
  // Make sure to dispose all controllers when exits
  @override
  void dispose() {
